                ...
                success: res => {
                  ...
                  wx.showModal({
                    ...
                    success(res) {
                      if (res.confirm) {
                        wx.previewImage({
                          urls: ['https://7777-wwgtx-4gm2qdmjf2daf8a8-1312229984.tcb.qcloud.la/images/tips/appreciateimg.jpg?sign=ccef2ea4ccb542b538b0de31c22812d2&t=1654504605'],
                        })
                      }
                    }
                  })

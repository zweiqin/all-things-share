...
export declare const preProcess: () => (_target: any, propertyKey: string, descriptor: PropertyDescriptor) => void;
export declare function processReturn(throwOnCode: boolean, res: any): any;
export declare function transformDbObjFromNewToOld(val: any, oldDb: any, visited: object[]): any;
